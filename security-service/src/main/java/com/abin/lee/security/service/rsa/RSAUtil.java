<<<<<<< HEAD
package com.abin.lee.security.service.rsa;
...
public class RSAUtil {
    ...
    private static final Integer SIGN_KEY_LENGTH = 2048;
    ...
    public static PrivateKey initPrivateKey() throws Exception {
        ...
        try {
            String rootPath = RSAUtil.class.getResource("/").getPath();
            bufferedReader = new BufferedReader(new FileReader(rootPath+PRIVATE_KEY_PATH));
    ...
    public static PublicKey initPublicKey() throws Exception{
        ...
        try {
            String rootPath = RSAUtil.class.getResource("/").getPath();
            bufferedReader = new BufferedReader(new FileReader(rootPath+PUBLIC_KEY_PATH));
            StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String encrypt(String content) throws Exception {
        ...
        int i = 0;
        // 对数据分段加密
        int maxEncryptBlock = calcMaxEncryptBlock(SIGN_KEY_LENGTH);
    ...
    public static String decrypt(String encryptedContent) throws Exception {
        ...
        int i = 0;
        // 对数据分段解密
        int maxDecryptBlock = calcMaxDecryptBlock(SIGN_KEY_LENGTH);
        while (inputLen - offSet > 0) {
...
>>>>>>> 915725b2f9ed657c27141958de1c66f14e3762f9
